                    ...
                    <div className={playersScreen1 ? "grid" : ""} style={{}}>
                        <>
                            ...
                            {playersScreen1 ? (Object.entries(showModal2 ? playersScreen2 : playersScreen1).map((player, playerIndex) => ( // note: players = [key, value]
                                <div key={playerIndex}>
                                    {/* {console.log("in doubleplayer is: ", player, " so val should be ", Object.values(player[1]))} */}
                            ...
                            {/* {Object.keys(playersScreen1).length > 0 ? ((showModal2 ? playersScreen2 : playersScreen1).map((player, playerIndex) => (
                                <div key={playerIndex}>
                                    {Object.keys(player).map((key, valueIndex) => (
                                        <PlayerCircle class="grid-item" key={valueIndex} playerName={key} playerImage={player[key]} onClickCallback={showModal2 ? handleScreen2Click : handleScreen1Click} isSelected={showModal2 ? selectedPLayersS2.includes(key) : selectedPLayersS1.includes(key)} />
                                    ))}
                                </div>
                            ))) : <p style={{
                                width: "100%", display: "flex", justifyContent: "center", alignItems: "center"
